...
| **HEAD ref** | `16fe7f3` — 376 páginas, 256 negocios, 29 guías + 4 frentes nuevos (escapadas verano, /compras, /comida-a-domicilio, /actualidad), WebP (2026-06-28) |
...
- **376 páginas:** `/`, `/[categoria]`, `/[categoria]/[slug]`, `/zona/[zona]`, `/zona/[zona]/[categoria]`,
  ...
  **`/comida-a-domicilio`** (ranking delivery), **pilares de contenido** (`/vivir-en-el-canaveral` keystone,
